...
#include "TauAnalysis/JetToTauFakeRate/interface/RootUtils.h"
#include "TauAnalysis/JetToTauFakeRate/interface/JSONWrapper.h"
// Deactivated morphing: #include "HiggsAnalysis/CombinedLimit/interface/th1fmorph.h"
...
//               if(histoL->Integral()>0 && histoR->Integral()>0){
                 TH1D* histo  = NULL; // Deactivated morphing: th1fmorph("interpolTemp","interpolTemp", histoL, histoR, massL, massR, mass, (1-Ratio)*histoL->Integral() + Ratio*histoR->Integral(), 0);
            ...
            if(histoL->Integral()>0 && histoR->Integral()>0){            
               ...
               // Deactivated morphing: histo->Add(th1fmorph("interpolTemp","interpolTemp", histoL, histoR, massL, massR, mass, Integral, 0), 1.0);
