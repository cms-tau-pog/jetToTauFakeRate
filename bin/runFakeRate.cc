...
public:
    ...
    fancy_(fancy)
  {
    ...
    else if(name_=="IsolationMVA3oldDMwoLT")
      {
        out_="oldwo";
    ...
    else if(name_=="IsolationMVA3oldDMwLT")
      {
        out_="oldw";
        wp_.push_back("VLoose");   colour_.push_back(TColor::GetColor(102, 153, 255));marker_.push_back(24);dataMarker_.push_back(20);
        wp_.push_back("Loose");    colour_.push_back(TColor::GetColor(  0, 153,   0));marker_.push_back(25);dataMarker_.push_back(21);
    ...
    else if(name_=="IsolationMVA3newDMwoLT")
      {
        out_="newwo";
        wp_.push_back("VLoose");  colour_.push_back(TColor::GetColor(102, 153, 255));marker_.push_back(24);dataMarker_.push_back(20);
        wp_.push_back("Loose");   colour_.push_back(TColor::GetColor(  0, 153,   0));marker_.push_back(25);dataMarker_.push_back(21);
    ...
    else if(name_=="IsolationMVA3newDMwLT")
      {
        out_="neww";
        wp_.push_back("VLoose");   colour_.push_back(TColor::GetColor(102, 153, 255));marker_.push_back(24);dataMarker_.push_back(20);
        wp_.push_back("Loose");    colour_.push_back(TColor::GetColor(  0, 153,   0));marker_.push_back(25);dataMarker_.push_back(21);
...
int main (int argc, char *argv[])
{
  ...
  gSystem->Exec("mkdir -p ${HOME}/www/13TeV_tauFakes_spring15/");
  gSystem->Exec("rm -r ${HOME}/www/13TeV_tauFakes_spring15/devel/");
  gSystem->Exec("cp ${HOME}/www/HIG-13-026/index.php devel/");
  gSystem->Exec("mv devel/ ${HOME}/www/13TeV_tauFakes_spring15/");
